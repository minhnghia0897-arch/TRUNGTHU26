...
export default async function OrderPage({
  ...
  searchParams: Promise<{ box?: string; combo?: string; la?: string; region?: string }>;
}) {
  ...
  const initial: InitialSelection = { box: sp.box, combo: sp.combo, la: sp.la, region: sp.region };
  return (
    <OrderFlow
      boxes={boxes}
      flavors={flavors}
